...
-(void)createColorBord{
    ...
    //色板的view
    UIView *colorBoardView = [[UIView alloc]initWithFrame:CGRectMake(0, height - 78, width, 20)];
    ...
    NSArray *colors = [NSArray arrayWithObjects:
                       ...
                       [UIColor redColor],[UIColor orangeColor],[UIColor brownColor],
                       [UIColor yellowColor],[UIColor greenColor],[UIColor blueColor],
                       [UIColor purpleColor],[UIColor cyanColor], nil];
    for (int i =0; i<colors.count; i++) {
        UIButton *btn = [[UIButton alloc]initWithFrame:CGRectMake((width/colors.count)*i, 0, width/colors.count, width/colors.count)];
        btn.layer.masksToBounds = YES;
        [btn.layer setCornerRadius:width/colors.count * 0.5];
...
-(void)createStrokeWidthSlider{
    slider = [[UISlider alloc]initWithFrame:CGRectMake(10, height - 35, width - 20, 20)];
